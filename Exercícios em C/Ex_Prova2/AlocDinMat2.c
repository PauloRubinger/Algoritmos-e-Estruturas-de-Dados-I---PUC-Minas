...
contidos em sua diagonal secund´aria. */
...
void sumSecondaryDiagonal(float **matriz, int rows, int columns){
    ...
    printf("The sum of the elements of the secondary diagonal is %f \n", sum);
}
...
int main(){
    ...
    sumSecondaryDiagonal(matriz, rows, columns);
